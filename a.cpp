        ...
        for (int i = 0; i < n; i++)
        {
            ...
            for (int j = 0; j < B - 1; j++)
            {
                ...
                else
                {
                    ...
                    A[j] = new Page();
                    A[j]->Data.insert(A[j]->Data.begin(),Pages[j + i * (B - 1)]->Data.begin(),Pages[j + i * (B - 1)]->Data.end());
                }
            }
            // cout<<endl;
            // cout<<"Reached"<<endl;
